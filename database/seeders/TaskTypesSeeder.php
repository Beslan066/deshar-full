...
[
    ...
    'name' => 'Соедени слова с категориями',
    'icon' => 'bx bx-grid-alt',
    'description' => 'Соедени слова с правильными категориями',
    'default_config' => [
        'items' => [
...
[
    ...
    'default_config' => [
        ...
        'variants' => [
            ['id' => 1, 'content' => 'Существительное', 'correctColor' => '#FF0000'],
            ['id' => 2, 'content' => 'Глагол', 'correctColor' => '#0000FF'],
        ],
    ],
    'is_active' => true,
    'sort_order' => 19,
    ...
    'default_config' => [
        'data' => [
            [
                ...
                'completed' => false,
                'variants' => [
                    ['id' => 101, 'value' => 'Следовательно'],
                    ['id' => 102, 'value' => 'связаны'],
                ],
                'slots' => [
...
[
    ...
    'default_config' => [
        'items' => [
            ['id' => 1, 'imageUrl' => '/images/animals/cat.png', 'correctVariantId' => 10],
            ['id' => 2, 'imageUrl' => '/images/animals/dog.png', 'correctVariantId' => 20],
        ],
        'variants' => [
            ['id' => 10, 'value' => 'Кот'],
            ['id' => 20, 'value' => 'Собака'],
...
[
    ...
    'default_config' => [
        'items' => [
            ['id' => 1, 'content' => 'Зимой падает белый...', 'correctVariantId' => 5],
        ],
        'variants' => [
            ['id' => 5, 'value' => 'снег'],
            ['id' => 6, 'value' => 'дождь'],
...
[
    ...
    'default_config' => [
        'items' => [
            ['id' => 1, 'imageUrl' => '/images/clothes/jacket.png', 'correctVariantId' => 301],
        ],
        'variants' => [
            ['id' => 301, 'value' => 'Куртка'],
            ['id' => 302, 'value' => 'Шапка'],
