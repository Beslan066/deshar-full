...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderChooseOne(config) {
        ...
        defaultOptions.forEach((opt, index) => {
            ...
            html += `
                <div class="option-card">
                    ...
                    <button type="button" class="btn-remove-item" onclick="window.removeOption(this)" title="Удалить вариант">
                        <i class="bx bx-x"></i>
                    </button>
                </div>
            `;
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addOption()">
    ...
    function renderMatchImages(config) {
        ...
        defaultPairs.forEach((pair, index) => {
            html += `
                <div class="pair-card">
                    ...
                    <button type="button" class="btn-remove-item" onclick="window.removePair(this)">
                        <i class="bx bx-x"></i>
                    </button>
                </div>
            `;
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addPair()">
        ...
        let html = `
            ...
            <div class="config-field-group">
                ...
                <textarea class="form-control" name="config[letters]"
                          ...
                          rows="2" style="font-family: monospace; font-size: 14px;">${escapeHtml(JSON.stringify(letters, null, 2))}</textarea>
                <small class="text-muted">Введите массив букв в формате JSON</small>
            </div>

            <div class="config-field-group">
                <label>Лишние буквы (опционально)</label>
                <textarea class="form-control" name="config[extra_letters]"
                          placeholder='["А", "О"]'
                          rows="2" style="font-family: monospace; font-size: 14px;">${escapeHtml(JSON.stringify(extraLetters, null, 2))}</textarea>
    ...
    function renderFixWord(config) {
        ...
        let html = `
            ...
            <div class="config-field-group">
                ...
                <textarea class="form-control" name="config[correct_forms]"
                          placeholder='["облака", "облаков", "облаками"]'
                          rows="2" style="font-family: monospace; font-size: 14px;">${escapeHtml(JSON.stringify(correctForms, null, 2))}</textarea>
    ...
    function renderConnectCategory(config) {
        ...
        defaultItems.forEach((item, index) => {
            html += `
                <div class="pair-card" style="grid-template-columns: 1fr 1fr auto;">
                    ...
                    <button type="button" class="btn-remove-item" onclick="this.closest('.pair-card').remove(); window.updateJsonPreview();">
                        <i class="bx bx-x"></i>
                    </button>
                </div>
            `;
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addConnectItem()">
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addConnectCategory()">
            ...
            <div class="config-field-group">
                ...
                <textarea class="form-control" name="config[line_colors]"
                          placeholder='["#FF6B6B", "#4ECDC4", "#45B7D1"]'
                          rows="2" style="font-family: monospace; font-size: 14px;">${escapeHtml(JSON.stringify(lineColors, null, 2))}</textarea>
            </div>
    ...
    function renderAlphabetWords(config) {
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addAlphabetWord()">
            ...
            <div class="config-field-group">
                ...
                <textarea class="form-control" name="config[shuffled_words]"
                          placeholder='[5, 1, 7, 3, 0, 6, 4, 2]'
                          rows="2" style="font-family: monospace; font-size: 14px;">${escapeHtml(JSON.stringify(shuffled, null, 2))}</textarea>
        ...
        let html = `
            <div class="config-field-group">
                ...
                <textarea class="form-control" name="config[letters]"
                          ...
                          rows="3" style="font-family: monospace; font-size: 14px;">${escapeHtml(JSON.stringify(letters, null, 2))}</textarea>
                <small class="text-muted">Введите массив букв с позициями в формате JSON</small>
            </div>

            <div class="config-field-group">
                <label>Перемешанные буквы</label>
                <textarea class="form-control" name="config[shuffled_letters]"
    ...
    function renderAlphabetImages(config) {
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addAlphabetImage()">
            ...
            <div class="config-field-group">
                <label>Перемешанный порядок</label>
                <textarea class="form-control" name="config[shuffled_items]"
                          placeholder='[2, 0, 1]'
                          rows="2" style="font-family: monospace; font-size: 14px;">${escapeHtml(JSON.stringify(shuffled, null, 2))}</textarea>
                <small class="text-muted">Введите массив индексов в перемешанном порядке</small>
            </div>
    ...
    function renderConnectLetters(config) {
        ...
        let html = `
            <div class="config-field-group">
                ...
                <textarea class="form-control" name="config[letters]"
                          placeholder='[{"id": 1, "letter": "А", "position": {"x": 100, "y": 200}}]'
            ...
            <div class="config-field-group">
                ...
                <textarea class="form-control" name="config[correct_order]"
                          placeholder='["А", "Б", "В", "Г", "Д"]'
                          rows="2" style="font-family: monospace; font-size: 14px;">${escapeHtml(JSON.stringify(correctOrder, null, 2))}</textarea>
    ...
    function renderFindByRule(config) {
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addFindByRuleWord()">
                    <i class="bx bx-plus"></i> Добавить слово
                </button>
            </div>
    ...
    function renderDragToImage(config) {
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addDragToImagePair()">
                    <i class="bx bx-plus"></i> Добавить пару
                </button>
            </div>
    ...
    function renderFindByCondition(config) {
        ...
        let html = `
            <div class="config-field-group">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-6">
                        <textarea class="form-control" name="config[condition][correct_indices]"
                                  placeholder='[0, 2]'
                                  rows="2" style="font-family: monospace; font-size: 14px;">${escapeHtml(JSON.stringify(condition.correct_indices || [], null, 2))}</textarea>
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addFindByConditionImage()">
                    <i class="bx bx-plus"></i> Добавить изображение
                </button>
            </div>
    ...
    function renderMatchBehavior(config) {
        ...
        let html = `
            <div class="config-field-group">
                ...
                <textarea class="form-control" name="config[behaviors]"
                          placeholder='["Правильное общение", "Неправильное общение"]'
                          rows="2" style="font-family: monospace; font-size: 14px;">${escapeHtml(JSON.stringify(behaviors, null, 2))}</textarea>
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addMatchBehaviorItem()">
                    <i class="bx bx-plus"></i> Добавить элемент
                </button>
            </div>
    ...
    function renderBuildDialogue(config) {
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addBuildDialogue()">
            ...
            <div class="config-field-group">
                <label>Варианты ответов <span class="text-danger">*</span></label>
                <textarea class="form-control" name="config[options]"
                          placeholder='[{"id": 1, "text": "Привет, Маша!"}]'
                          rows="3" style="font-family: monospace; font-size: 14px;">${escapeHtml(JSON.stringify(options, null, 2))}</textarea>
    ...
    function renderDragDropText(config) {
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addDragDropSentence()">
            ...
            <div class="config-field-group">
                ...
                <textarea class="form-control" name="config[words]"
                          placeholder='["гӏаькх", "воал", "саг"]'
                          rows="2" style="font-family: monospace; font-size: 14px;">${escapeHtml(JSON.stringify(words, null, 2))}</textarea>
                <small class="text-muted">Введите массив слов в формате JSON</small>
            </div>

            <div class="config-field-group">
                <label>Лишние слова (опционально)</label>
                <textarea class="form-control" name="config[extra_words]"
                          placeholder='["кхы"]'
                          rows="2" style="font-family: monospace; font-size: 14px;">${escapeHtml(JSON.stringify(extraWords, null, 2))}</textarea>
    ...
    function renderStoryOrder(config) {
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addStoryPart()">
    ...
    // ============================================================
    // РЕНДЕРИНГ "Сопоставь с категориями" (color_categories)
    // ============================================================
    function renderColorCategories(config) {
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addColorItem()">
                    <i class="bx bx-plus"></i> Добавить элемент
                </button>
            </div>
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addColorCategory()">
                    <i class="bx bx-plus"></i> Добавить категорию
                </button>
            </div>
    ...
    function renderMatchPairs(config) {
        ...
        html += `
                ...
                <button type="button" class="btn-add-item" onclick="window.addMatchPair()">
                    <i class="bx bx-plus"></i> Добавить пару
                </button>
            </div>
