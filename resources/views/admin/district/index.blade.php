                ...
                <div class="card-datatable table-responsive pt-0">
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                        <div class="card-header flex-column flex-md-row border-bottom">
                            <div class="head-label text-center"><h5 class="card-title mb-0">Районы</h5></div>
                        ...
                        <table class="table">
                            ...
                            @foreach($districts as $district)
                                <tr>
                                    <td>
                                        <span class="fw-medium">{{$district->id}}</span>
                                    </td>
                                    <td>{{$district->name}}</td>
                                    <td>
                                    ...
                                    <td><span class="badge rounded-pill bg-label-primary me-1">{{$district->created_at}}</span></td>
                                    <td>
                                        <div class="dropdown">
